	...
	private void initialize() {
		...
		save.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int sucess = Goods.modifyGoods(correctedName, goodName.getText(), price.getText(),
						stockAmount.getText(), discount.getText(), ctgName.getText());
				if (sucess == 0) {
		...
		cancle.setBounds(243, 233, 97, 23);
